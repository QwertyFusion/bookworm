              ...
              <li
                ...
                <Link href={`/dashboard/${file.id}`} className="flex flex-col gap-2">
                  <div className='pt-6 px-6 flex w-full items-center justify-between space-x-6'>
                    <div className={`h-10 w-10 flex-shrink-0 rounded-full bg-gradient-to-r ${getGradientByIndex(index)}`} />
                ...
                <div className='px-6 mt-4 flex flex-row items-center justify-between place-items-center py-2 gap-6 text-xs text-zinc-500'>
                  ...
                  <Button onClick={() => deleteFile({ id: file.id })}
                    size='sm' className="w-fit hover:bg-red-200" variant="destructive">
